...
#define OMNI_MODE_MINING_PICK 13
#define OMNI_MODE_MINING_DRILL 14
#define OMNI_MODE_MINING_HAMMER 15
#define OMNI_MODE_MINING_SHOVEL 16
#define OMNI_MODE_MINING_LASER 17
#define OMNI_MODE_MINING_CONCUSSION 18
