...
/mob/living/carbon/human/proc/update_bloody_suit()
	if (src.wear_suit?.is_stained)
		...
		blood_image.color = src.wear_suit.stain_color
...
/mob/living/carbon/human/proc/update_bloody_uniform()
	if (src.w_uniform?.is_stained)
		...
		blood_image.color = src.w_uniform.stain_color
...
/mob/living/carbon/human/proc/update_bloody_mask()
	...
	if (src.wear_mask)
		if (src.wear_mask.use_bloodoverlay && src.wear_mask.is_stained)
			...
			blood_image.color = src.wear_mask.stain_color
...
/mob/living/carbon/human/proc/update_bloody_head()
	...
	if (src.head?.is_stained)
		...
		blood_image.color = src.head.stain_color
...
/mob/living/carbon/human/proc/update_bloody_gloves()
	...
	if (src.gloves?.is_stained)
		...
		if (src.limbs && src.limbs.l_arm && src.limbs.l_arm.accepts_normal_human_overlays)
			blood_image.color = src.gloves.stain_color
...
/mob/living/carbon/human/proc/update_bloody_shoes()
	if (src.shoes?.is_stained)
		if (src.limbs && src.limbs.l_leg && src.limbs.l_leg.accepts_normal_human_overlays)
			...
			blood_image.color = src.shoes.stain_color
...
/mob/living/carbon/human/proc/update_bloody_hands()
	...
	if (!src.gloves && src.limbs)
		if(src.limbs.l_arm && src.limbs.l_arm.accepts_normal_human_overlays && src.limbs.l_arm.is_stained)
			var/image/blood_image = src.SafeGetOverlayImage("bloody_hands_l", 'icons/obj/decals/blood/blood.dmi', layer=MOB_HAND_LAYER2 + 0.1)
			blood_image.pixel_y = hand_offset
			blood_image.color = src.limbs.l_arm.stain_color
		...
		if (src.limbs.r_arm && src.limbs.r_arm.accepts_normal_human_overlays && src.limbs.r_arm.is_stained)
			var/image/blood_image = src.SafeGetOverlayImage("bloody_hands_r", 'icons/obj/decals/blood/blood.dmi', layer=MOB_HAND_LAYER2 + 0.1)
			blood_image.pixel_y = hand_offset
			blood_image.color = src.limbs.r_arm.stain_color
...
/mob/living/carbon/human/proc/update_bloody_feet()
	if (!src.shoes && src.limbs)
		if (src.limbs.l_leg && src.limbs.l_leg.accepts_normal_human_overlays && src.limbs.l_leg.is_stained)
			...
			blood_image.color = src.limbs.l_leg.stain_color
			blood_image.icon_state = "left_shoeblood_c"
			src.AddOverlays(blood_image, "bloody_feet_l")
		else
			src.ClearSpecificOverlays("bloody_feet_l")

		if (src.limbs.r_leg && src.limbs.r_leg.accepts_normal_human_overlays && src.limbs.r_leg.is_stained)
			...
			blood_image.color = src.limbs.r_leg.stain_color
			blood_image.icon_state = "right_shoeblood_c"
